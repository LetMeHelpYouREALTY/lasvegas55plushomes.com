...
export const metadata: Metadata = {
  ...
  description: 'Security policy and responsible disclosure information for lasvegas55plushomes.com',
  robots: {
    index: true,
    follow: true,
  },
      ...
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>Ensure you're on the correct domain: <strong>lasvegas55plushomes.com</strong></li>
